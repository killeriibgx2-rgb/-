...
public class ModEntities {
    ...
    // ИСПРАВЛЕНО: Вернули стандартный метод создания LivingEntity через ::new, чтобы мир не крашился при создании
    ...
    // ИСПРАВЛЕНО: Вернули стандартный метод создания для ракеты через ::new
