...
public class ci4<T extends Entity> extends EntityModel<T> {
	// Привязываем слой модели к нашему ID мода fly_drone
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation(FlyDroneMod.MOD_ID, "ci4"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		bone.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(46, 34).addBox(-2.0F, -1.0F, -8.0F, 7.0F, 1.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -1.0F, 1.0F, 0.0F, 0.0F, 1.5708F));
		bone.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 34).addBox(-2.0F, -1.0F, -8.0F, 7.0F, 1.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -1.0F, 1.0F, 0.0F, 0.0F, 1.5708F));
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		// Статическая модель взрывчатки, анимация не требуется
	}
