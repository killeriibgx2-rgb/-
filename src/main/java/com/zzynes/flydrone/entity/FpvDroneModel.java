...
public class FpvDroneModel extends GeoModel<FpvDroneEntity> {
    ...
    @Override
    public ResourceLocation getModelResource(FpvDroneEntity entity) {
        return new ResourceLocation("fly_drone", "geo/fpv_drone.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(FpvDroneEntity entity) {
        return new ResourceLocation("fly_drone", "textures/entity/fpv_drone.png");
    }

    @Override
    public ResourceLocation getAnimationResource(FpvDroneEntity entity) {
