...
java.lang.IllegalStateException: Failed to load registries due to above errors
	...
	at org.lwjgl.glfw.GLFWMouseButtonCallbackI.callback(GLFWMouseButtonCallbackI.java:43) ~[lwjgl-glfw-3.3.1.jar%23128!/:build 7] {}
	at org.lwjgl.system.JNI.invokeV(Native Method) ~[lwjgl-3.3.1.jar%2399!/:build 7] {}
	at org.lwjgl.glfw.GLFW.glfwWaitEventsTimeout(GLFW.java:3474) ~[lwjgl-glfw-3.3.1.jar%23128!/:build 7] {}
...
Details:
	...
	Memory: 269342048 bytes (256 MiB) / 767557632 bytes (732 MiB) up to 8388608000 bytes (8000 MiB)
	CPUs: 24
	...
	Virtual memory used (MB): 13389.58
	...
	Crash Report UUID: d5d57914-c2cf-4173-9e52-52302acfb8ae
	FML: 47.4
