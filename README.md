...
java.lang.IllegalStateException: Failed to load registries due to above errors
	...
	at org.lwjgl.glfw.GLFWMouseButtonCallbackI.callback(GLFWMouseButtonCallbackI.java:43) ~[lwjgl-glfw-3.3.1.jar%23134!/:build 7] {}
	at org.lwjgl.system.JNI.invokeV(Native Method) ~[lwjgl-3.3.1.jar%23155!/:build 7] {}
	at org.lwjgl.glfw.GLFW.glfwWaitEventsTimeout(GLFW.java:3474) ~[lwjgl-glfw-3.3.1.jar%23134!/:build 7] {}
...
Details:
	...
	Memory: 196543224 bytes (187 MiB) / 566231040 bytes (540 MiB) up to 8388608000 bytes (8000 MiB)
	CPUs: 24
	...
	Virtual memory used (MB): 16550.79
	...
	Crash Report UUID: 47367bb3-fe31-42c1-85a0-480702582d09
	FML: 47.4
