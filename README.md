...
java.lang.IllegalStateException: Failed to load registries due to above errors
	...
	at org.lwjgl.system.JNI.invokeV(Native Method) ~[lwjgl-3.3.1.jar%2388!/:build 7] {}
	at org.lwjgl.glfw.GLFW.glfwWaitEventsTimeout(GLFW.java:3474) ~[lwjgl-glfw-3.3.1.jar%23109!/:build 7] {}
...
Details:
	...
	Memory: 195224280 bytes (186 MiB) / 704643072 bytes (672 MiB) up to 8388608000 bytes (8000 MiB)
	CPUs: 24
	...
	Virtual memory used (MB): 15733.08
	...
	Crash Report UUID: 1b635433-81c7-4b1b-a6b8-66c91bc31b9e
	FML: 47.4
