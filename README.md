...
java.lang.IllegalStateException: Failed to load registries due to above errors
	...
	at org.lwjgl.glfw.GLFWMouseButtonCallbackI.callback(GLFWMouseButtonCallbackI.java:43) ~[lwjgl-glfw-3.3.1.jar%23151!/:build 7] {}
	at org.lwjgl.system.JNI.invokeV(Native Method) ~[lwjgl-3.3.1.jar%23126!/:build 7] {}
	at org.lwjgl.glfw.GLFW.glfwWaitEventsTimeout(GLFW.java:3474) ~[lwjgl-glfw-3.3.1.jar%23151!/:build 7] {}
...
Details:
	...
	Memory: 285766432 bytes (272 MiB) / 771751936 bytes (736 MiB) up to 8388608000 bytes (8000 MiB)
	CPUs: 24
	...
	Virtual memory used (MB): 12869.59
	...
	Crash Report UUID: 5c32828c-f288-44f6-a8bf-bd5c90768ec8
	FML: 47.4
